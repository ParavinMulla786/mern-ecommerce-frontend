...
const AddProduct = () => {
  ...
  const handleChange = (e) => {
    ...
    // Sanitize product name - remove quotes
    if (name === 'productName') {
  ...
  const handleSubmit = async (e) => {
    ...
    // Clean the product name - remove quotes and special characters
    const cleanProductName = formData.productName.trim().replace(/["']/g, '');
    ...
    if (Number(formData.price) > 99999999) {
      validationErrors.push('Price seems too high. Please check the value.')
    }
    ...
    try {
      ...
      data.append('productName', cleanProductName)
      ...
      console.log('Sending cleaned product data:', {
          ...
          <Form onSubmit={handleSubmit}>
            <Form.Group className="mb-3">
              ...
              <Form.Control
                type="text"
                name="productName"
                placeholder="Enter product name (minimum 3 characters, no quotes)"
              ...
              <Form.Text className={formData.productName && formData.productName.length < 3 ? 'text-danger' : 'text-muted'}>
                {formData.productName.length}/3 characters minimum (no quotes allowed)
              </Form.Text>
